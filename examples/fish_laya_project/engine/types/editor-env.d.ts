...
declare global {
    ...
    export namespace IEditorEnv {
        ...
        export interface IHandles extends IGizmos3D {
            ...
            * @return The new center and size of the box.
            */
             ...
             * @return The new center, radius and height of the capsule.
             */
             ...
             * @return The new center, radius and height of the cylinder.
             */
             ...
             */
            editRectangle(matrix: Laya.Matrix, x: number, y: number, width: number, height: number): {
                valueChanged: boolean,
                center: Laya.Vector2,
                size: Laya.Vector2
            };
             ...
             */
            editCircle(matrix: Laya.Matrix, x: number, y: number, radius: number): {
                valueChanged: boolean,
                center: Laya.Vector2,
                radius: Laya.Vector2
            };
             ...
             */
            editEllipse(matrix: Laya.Matrix, x: number, y: number, radiusX: number, radiusY: number): {
                valueChanged: boolean,
                center: Laya.Vector2,
                radius: Laya.Vector2
            };
             ...
             */
            editPath(matrix: Laya.Matrix, x: number, y: number, points: number[], closed: boolean, lineWidth?: number, lineColor?: Laya.Color, fixedLength?: boolean): {
                valueChanged: boolean,
                points: number[],
                addedIndex: number
            };
             ...
             * @param path The CurvePath instance.
             * @param lineWidth The line width. Default is 1.
             * @param lineColor The line color. Default is Color.CLEAR(transparent).
             */
            editCurvePath(matrix: Laya.Matrix, x: number, y: number, path: Laya.CurvePath, lineWidth?: number, lineColor?: Laya.Color): {
                valueChanged: boolean,
                /** Segment index where a point should be added, -1 if none. */
                addedSegment: number,
                /** Parameter t within the segment for the added point. */
                addedT: number,
                /** Logical path point index to delete, -1 if none. */
                deletedIndex: number
            };
             ...
             */
            showHandle<T extends HandleBase>(handleClass: new () => T, ...args: Parameters<T['execute']>): T;
             ...
             */
            setContextMenu(callback: () => void): void;
        }
        ...
        export interface IGizmosManager {
            ...
            setCursorForHandle(cursor: string): void;
            setContextMenuForHandle(callback: () => void): void;

            pickGizmo(x: number, y: number): Laya.Node | null;
            getSprite3DsInRect(frustum: Laya.BoundFrustum, result: Laya.Node[]): void;

            startDrag(sprite: Laya.Sprite): void;
            drawSelectionRange(rect: Laya.Rectangle): void;
        ...
        export interface IGizmos3D {
             ...
             * @return The mesh of the specified type. 
             */
            getMesh(type: GizmoMeshKey): Laya.Mesh;
             ...
             */
            drawLine(start: Laya.Vector3, end: Laya.Vector3, color?: Laya.Color): void;
             ...
             * @param ednAllow Whether to allow drawing the end point. 
             * @param color The line color. Default is white. 
             */
            drawArcLine(start: Laya.Vector3, end: Laya.Vector3, height: number, startAllow: boolean, ednAllow: boolean, color?: Laya.Color): void;
             ...
             * @param height The height of the capsule. 
             * @param color The line color. Default is white. 
             * @param rotation The rotation of the capsule. Default is null. 
             */
             ...
             * @param color The line color. Default is white. 
             * @param rotation The rotation of the hemisphere. Default is null. 
             */
             ...
             * @param color Color.
             */
            drawMesh(mesh: Laya.Mesh, subMeshIndex: number, position?: Laya.Vector3, rotation?: Laya.Quaternion, scale?: Laya.Vector3, color?: Laya.Color): void;
             ...
             */
            drawMeshLine(mesh: Laya.Mesh, subMeshIndex: number, position?: Laya.Vector3, rotation?: Laya.Quaternion, scale?: Laya.Vector3, color?: Laya.Color): void;
             ...
             * @param scaleX Text X-axis display scale (optional, default is 1.0)
             * @param scaleY Text Y-axis display scale (optional, default is 1.0)
             * @param fontWeight Font weight (optional, default is "normal", such as "normal", "bold", "bolder", "lighter", or numeric values like "100", "200", etc.)
             * @param fontFamily Font family (optional, default is "Arial", such as "Arial", "Times New Roman", etc.)
             */
        ...
        export interface IGizmos2D {
             ...
             */
            switchEditingGraphics(node: Laya.Node, comp?: Laya.Component, propPath?: Array<string>): void;
             ...
             * @param points line points,4 number show one line
             ...
             * @param x The x position of the path in screen coordinates. 
             * @param y The y position of the path in screen coordinates. 
             ...
             */
            drawPath(matrix: Laya.Matrix, x: number, y: number, points: number[], closed?: boolean, lineWidth?: number, lineColor?: Laya.Color): void;
             ...
             * @param x The x position of the path in screen coordinates. 
             * @param y The y position of the path in screen coordinates. 
             * @param points Polygon points, 2 numbers show one point (x,y). 
